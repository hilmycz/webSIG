...
<div class="mb-3"><?php echo anchor('tambahsekolah','<i class="fa-solid fa-plus"></i>',['class'=>'btn btn-primary']); ?></div>
<table class="table table-hover table-striped table-bordered">
<thead class="table-primary">
<tr>
<th>No</th>
<th>Kecamatan</th><th>NPSN</th>
<th>Nama Sekolah</th>
...
anchor('hapussekolah/'.$baris->npsn,'<i class="fa-solid fa-trash-can"></i>',['class'=>'btn btn-danger']);?>
</td>
</tr>
<?php
}
