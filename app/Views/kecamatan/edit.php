...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-itemscenter pt-3
pb-2">
...
echo
form_dropdown('id_kabupaten',$kabupatenOptions,$query->id_kabupaten,'class="form-control"');?>
</div>
<div
class="mb-3">
